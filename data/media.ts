...
export const media = {
  ...
  "service-grooming": {
    src: "/photos/service-drop-in-visits.jpg",
    alt: "Hands drying a dog's paws on a kitchen towel after a bath",
    width: 1536,
    height: 1024,
    tone: "mint",
    motif: "none",
    brief: "At-home grooming: tub or kitchen floor, towel, calm dog. Not a salon.",
  },
  "service-pet-transportation": {
    src: "/photos/careers-team.jpg",
    alt: "A caregiver loading leashes into a car on a quiet residential street",
    width: 1536,
    height: 1024,
    tone: "sand",
    motif: "none",
    brief: "Door-to-car moment. Residential street, leash in hand, no studio.",
  },
  "service-adventure-outings": {
    ...
    tone: "sand",
    motif: "none",
    brief: "Trail or conservation land, moving dog, real dirt and light.",
  },
  "report-photo-1": {
    src: "/photos/report-photo-1.jpg",
    alt: "A beagle mid-walk on a gravel path, tail up",
